<form action="{{ $action }}" method="post">
    ...
    <input class="form-control" type="text" id="city" name="city" @isset($city)value="{{ $city }}"@endisset required>

    <label class="form-label" for="state">Estado:</label>
    <input class="form-control" type="text" id="state" name="state" @isset($state)value="{{ $state }}"@endisset required>
    </div>
